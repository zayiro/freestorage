...
<div class="container mt-5">
    ...
    {{-- Botón para crear --}}
    <a href="{{ route('presentations.create', ['product_id' => request('product_id')]) }}" class="btn btn-primary mb-3">Nueva Presentación</a>
    @if(!empty(($presentations)))
        ...
        {{ $presentations->links() }}
    @else        
        <div>No tiene presentaciones de producto registradas en el momento.</div>             
    @endif
</div>
@endsection